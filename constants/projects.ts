...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Diseño y desarrollo (Figma to code) de landing page corporativa y catálogo de productos. Desarrollado utilizando Next.js (App router), optimizado aprovechando el SSR (renderizado del lado del servidor).',
    image: power,
  ...
  },
  {
    category: 'Aplicación web',
    name: 'TableMaster',
    description: 'Desarrollo en progreso de aplicación para reservar mesas en restaurantes. Desarrollada utilizando Next.js y la librería de UI Shadcn.',
    image: tablemaster,
